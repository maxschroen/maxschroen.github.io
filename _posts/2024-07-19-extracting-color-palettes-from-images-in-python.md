...
<figure align="center">
  <img src="/assets/images/posts/color-palettes/misery-signals-of-malice-and-the-magnum-heart.jpg" alt="example artwork poster" width="400"/>
  <figcaption style="font-size: small">Example Album Poster with Colored Blobs </figcaption>
</figure>
...
<figure align="center">
  <img src="/assets/images/posts/color-palettes/compression-artifact-example.png" alt="example compression artifacts" width="500"/>
  <figcaption style="font-size: small">Compression Artefact Example (<a href="https://www.researchgate.net/publication/334360686_Fully_Convolutional_Network_for_Removing_DCT_Artefacts_From_Images">Source</a>)</figcaption>
</figure>
...
<figure align="center">
  <img src="/assets/images/posts/color-palettes/k-means-animation.gif" width="400">
  <figcaption style="font-size:small;">K-Means Clustering Animation (<a href="https://code-specialist.com/python/k-means-algorithm">Source</a>)</figcaption>
</figure>
...
<figure align="center">
  <img src="/assets/images/posts/color-palettes/color-palette.jpg" width="400">
  <figcaption style="font-size:small;">Sample Image (<a href="https://unsplash.com/photos/a-field-with-a-mountain-in-the-background-r_wAAUeXDcQ">Source</a>) with Extracted Color Palette</figcaption>
</figure>
...
colors_sorted = [color for color in sorted(colors, key=lambda color: luminance(color), reverse=True)]
```
...
<figure align="center">
  <img src="/assets/images/posts/color-palettes/color_comparison.png" width="300">
  <figcaption style="font-size:small;">Luminance vs. Naive Color Rankings</figcaption>
</figure>
